...
export default function SystemStatus({ detections = [], active = false }) {
  ...
  const META = {
    ...
    initializing: {
      ...
      dotColor: "#f59e0b",
      glow:     "0 0 20px rgba(245,158,11,0.65)",
      pulse:    true,
    ...
    tracking: {
      ...
      dotColor: "#00c9b5",
      glow:     "0 0 22px rgba(0,201,181,0.7)",
      pulse:    false,
      border:   "rgba(0,201,181,0.5)",
      bg:       "rgba(0,201,181,0.10)",
      textColor:"#00e5d0",
      icon:     "◈",
    },
  };
  ...
  return (
    <div style={{
      ...
      boxShadow: m.glow !== "none" ? `${m.glow}, inset 0 1px 0 rgba(255,255,255,0.08)` : "inset 0 1px 0 rgba(255,255,255,0.06)",
    }}>
      <style>{`
